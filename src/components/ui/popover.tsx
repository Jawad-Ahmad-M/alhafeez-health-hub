...
>(({ className, align = "center", sideOffset = 4, ...props }, ref) => (
  <PopoverPrimitive.Portal>
    <PopoverPrimitive.Content
      ...
      className={cn(
        "glass z-50 w-72 rounded-xl border border-border/80 bg-popover/95 p-4 text-popover-foreground shadow-lift backdrop-blur-2xl outline-none dark:border-white/12 dark:bg-card/95",
